...
> 이 스킬이 무엇이고 왜 이렇게 짧은지는 [설명 페이지](https://choneuny.github.io/agent-kit/explain-with-pictures/)에 그림으로 적어 두었다.
...
- **Claude Code** — `~/.claude/skills/explain-with-pictures/` (저장소의 `skills/explain-with-pictures`를 가리키는 심링크)
